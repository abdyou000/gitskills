...
public class ImageUtil {
    ...
    private String randString = "23456789abcdefghijkmnpqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";// 随机产生的字符串
     ...
     * 生成随机图片
     */
    public void generateImage(HttpServletRequest request,HttpServletResponse response,String key) {
